...
ISL_ARG_BOOL(struct ppcg_options, coding_ants, 0, "coding-ants", 0,
	"optimize gpu code using ant colony optimizatin")
ISL_ARG_INT(struct ppcg_options, opt_level, 'S', "ca-O", "olevel", 1, NULL)
